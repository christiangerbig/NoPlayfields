...
vcs3111_step2_angle_speed       EQU 2 ;1..8 Rhytmus
vcs3111_step2_angle_step        EQU 6 ;Konstante Form
vcs3111_speed                   EQU 4 ;1..8 Geschwindigkeit
...
vert_colorscroll3111
  ...
  IFEQ vcs3111_switch_table_length_256
    addq.b  #vcs3111_speed,d0    ;Startwert der Switchtabelle erhöhen
  ELSE
    MOVEF.W vcs3111_switch_table_size-1,d3 ;Anzahl der Einträge
    addq.w  #vcs3111_speed,d0    ;Startwert der Switchtabelle erhöhen
