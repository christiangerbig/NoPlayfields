...
spr_odd_color_table_select      EQU 14 ;9
...
vert_scrolltext
  ...
  move.w  #vst_text_character_y_restart,d5 ;Y-Neustart
...
vst_text
  REPT vst_text_characters_number/((vst_origin_character_y_size+1)/vst_text_character_y_size)
    DC.B " "
  ENDR
  DC.B "RESISTANCE IS PROUD TO PRESENT A NEW INTRO CALLED  NO!BITPLANES      "
